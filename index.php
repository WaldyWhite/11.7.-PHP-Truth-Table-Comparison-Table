...
<body>
    <div class="container-main">
        <div class="container">
            ...
            <div class="box">
                <p class="text">И так, рассмотрев таблицы Гибкого и Жесткого сравнения можно сделать вывод, что при жестком сравнение значения равны сами себе,
                 тоесть сами значения и их типы равны, true равно только true, false равно только false и т.д.<br><br>
                При гибком сравнении сравниваются значения а их типы не учитываются. Так например, если значение будет 0, то при гибком сравнении  он определится как FALSE, 
                соответственно  0 будет равен false, так же 0 будет равен null поскольку  null это отсутствие чего-либо, ну и в конце концов 0 равен 0. Аналогично  и другие значения, так 1 будет равен "1", "1" это строка а символ 1 это цифра и т.д.
                </p>
            </div>
        </div>
    </div> 
